  ...
  return (
    <ViewShell error={error} onCloseError={() => setError('')}>
      <SectionHeader
        ...
        subtitle="Interactive portfolio intelligence and strategic financial analysis."
      ...
      <Box
        ...
        style={{
          borderRadius: 8,
          background: 'light-dark(#fffbeb, rgba(245, 158, 11, 0.07))',
          border: '1px solid light-dark(#fde68a, rgba(245, 158, 11, 0.25))',
        }}
      >
        <Group gap={8} wrap="nowrap" align="center">
          <IconAlertTriangle size={15} color="#d97706" style={{ flexShrink: 0 }} />
          <Text size="xs" style={{ color: 'light-dark(#92400e, #fef3c7)', lineHeight: 1.45 }}>
            <Text span fw={700} inherit>Financial Disclaimer:</Text>{' '}
            Portfolio Advisor analyses are for educational and informational purposes only and do not constitute certified financial, investment, legal, or tax advice. Always verify recommendations independently.
          </Text>
        </Group>
      </Box>
      ...
      {!userProfile.user_description.trim() && (
        <Paper
          ...
          radius="md"
          style={{
            background: 'light-dark(#f8fafc, #161b22)',
            borderColor: 'light-dark(#e2e8f0, #21262d)',
          }}
        >
          <Group justify="space-between" align="center">
            <Text size="xs" c="dimmed">
              Your investor profile is currently empty. Completing it helps Portfolio Advisor provide personalized advice.
            </Text>
            <Button size="compact-xs" variant="light" color="teal" component="a" href="?tab=settings">
        ...
        >
          <Box
            style={{
              ...
              background: 'light-dark(rgba(20, 184, 166, 0.10), rgba(20, 184, 166, 0.15))',
              color: 'var(--mantine-color-teal-6)',
              border: '1px solid light-dark(rgba(20, 184, 166, 0.25), rgba(20, 184, 166, 0.35))',
            }}
          >
          ...
          <Text size="sm" c="dimmed" style={{ maxWidth: 480, margin: '0 auto', lineHeight: 1.5 }}>
            Ask questions about asset allocation, rebalancing, fee drag, or query the live ETF catalog.
          </Text>
        </Paper>
      ) : (
        <Stack gap="md">
              ...
              >
                <Group justify="space-between" mb="xs">
                  <Text size="xs" fw={700} c={msg.role === 'user' ? 'teal.7' : 'dimmed'}>
                    {msg.role === 'user' ? 'You' : 'Portfolio Advisor'}
                  </Text>
                  <Text size="xs" c="dimmed">
                    {msg.timestamp}
                  </Text>
      ...
      <Paper
        ...
        style={{
          ...
          boxShadow: 'light-dark(0 4px 20px rgba(0,0,0,0.06), 0 -4px 20px rgba(0,0,0,0.35))',
        }}
      >
        <Stack gap="sm">
          <Textarea
...
function AISettingsModal({
  ...
  return (
    <Modal opened={opened} onClose={onClose} title="Portfolio Advisor & Model Settings" size="lg">
      <Stack gap="md">
